...
public class AcolyteTest{
    ...
    public  static  void add_more_cats(int n) throws SQLException {
        ...
        public  static int  rnd(int max){
            ...
            public  static void delete_cat(int id) throws SQLException {stat.execute("DELETE FROM cats WHERE id=="+id+";");}
            public static void delete_cat(String where) throws SQLException {stat.execute("DELETE FROM cats WHERE "+where+";");}
    public static void  update_cat(int id,String set,String where) throws SQLException {stat.execute("UPDATE cats SET "+set+" WHERE "+where+"; ");}
